...
// Initiating Payfast Payment (Sandbox)
export const initiatePayfastPayment = asyncHandler(async (req, res) => {
  ...
  const paymentData = {
    merchant_id: merchant_id || PAYFAST_MERCHANT_ID,
    merchant_key: merchant_key || PAYFAST_MERCHANT_KEY,
  ...
  console.log("✅ Redirecting to Payfast (Sandbox):", payfastUrl);
